          ...
          <div className="flex justify-between items-center max-w-[1400px] mx-auto pointer-events-auto">
            ...
            <MagneticButton
              href={getWhatsAppLink(
                "Gostaria de agendar uma consultoria C-Level para Projetos Black."
              )}
              className="text-xs uppercase tracking-widest font-bold magnetic-trigger"
            >
              Acesso Restrito
            </MagneticButton>
          </div>
        ...
        <>
          ...
          <section className="relative w-full min-h-screen flex flex-col items-center justify-center px-4 overflow-hidden z-10">
            <div className="text-center w-full max-w-[1400px]">
                  ...
                  >
                    <div className="w-full h-full relative overflow-hidden">
                      <video
                        ...
                        muted
                        playsInline
                        className="absolute top-1/2 left-1/2 min-w-full min-h-full -translate-x-1/2 -translate-y-1/2 object-cover grayscale brightness-150 contrast-125"
                      >
              ...
              >
                Nós não construímos "sites". Construímos engenharias de
                super-percepção de valor. O padrão <strong>Black</strong>{" "}
                garante que a concorrência se torne matemática e visualmente
                irrelevante.
              </motion.p>
            </div>
          </section>
          ...
          <section className="relative w-full min-h-screen flex items-center justify-center px-4 overflow-hidden z-10 py-20">
            ...
            >
              <div className="text-center group">
                <Target
                  className="w-12 h-12 mx-auto mb-6 text-white opacity-40 transition-opacity duration-500 group-hover:opacity-100"
                  strokeWidth={1}
                />
                <h3 className="text-2xl mb-4 font-light tracking-wide">
                  Física Vetorial
                </h3>
                <p className="text-[var(--be-text-darker)] px-4">
                  Motion Design com bibliotecas de física avançada. A tela
                  comporta-se como um fluído gravitacional.
                </p>
              </div>
              <div className="text-center group">
                <Zap
                ...
                <p className="text-[var(--be-text-darker)] px-4">
                  Manipulamos o campo de visão do seu cliente utilizando fundos
                  ultra-profundos e ausência cirúrgica de luz.
                </p>
              </div>
              <div className="text-center group">
                <Shield
                ...
                <p className="text-[var(--be-text-darker)] px-4">
                  Componentes reativos que rastreiam as coordenadas do cursor. A
                  percepção de tecnologia aumenta 10x.
                </p>
              </div>
            </motion.div>
          </section>
            ...
            >
              ...
              <div className="flex flex-col md:flex-row items-stretch gap-12 md:gap-8 max-w-6xl w-full">
                ...
                <TiltCard3D className="flex-1 h-auto py-12 md:py-0 md:h-[600px]">
                  <div className="text-xs uppercase tracking-[0.3em] mb-4 text-[var(--be-text-darker)] font-bold">
                    Base Cinematográfica
                  </div>
                  <div className="text-4xl font-light mb-10 tracking-tighter">
                    R$ 5.500
                  </div>
                  <div className="flex flex-col gap-5 text-sm font-light text-[var(--be-text-muted)] flex-grow mb-16">
                    <div className="flex justify-between border-b border-[rgba(255,255,255,0.05)] pb-3 text-white">
                      <span>Landing Page Premium</span>
                    </div>
                    <div className="flex justify-between border-b border-[rgba(255,255,255,0.05)] pb-3">
                      <span>Ux Copywriting Agressivo</span>
                    </div>
                    <div className="flex justify-between border-b border-[rgba(255,255,255,0.05)] pb-3">
                      <span>Tracking Google & Meta</span>
                    </div>
                  </div>

                  <MagneticButton
                    href={getWhatsAppLink(
                      "Olá! Tenho interesse na Base Cinematográfica (Black) de R$5.500."
                    )}
                    className="be-btn-secondary w-full magnetic-trigger text-center justify-center mt-auto"
                  >
                    Solicitar Acesso
                  </MagneticButton>
                </TiltCard3D>
                ...
                <TiltCard3D
                  featured={true}
                  className="flex-1 h-auto py-12 md:py-0 md:h-[600px]"
                >
                  <div className="text-xs uppercase tracking-[0.3em] mb-4 text-white drop-shadow-[0_0_10px_rgba(255,255,255,1)] font-bold">
                    Operação Elite
                  </div>
                  <div className="text-5xl font-light mb-10 tracking-tighter">
                    R$ 9.800
                  </div>
                  <div className="flex flex-col gap-5 text-sm font-light text-white flex-grow mb-16">
                    <div className="flex justify-between border-b border-[rgba(255,255,255,0.15)] pb-3">
                      <span>O Padrão Bilionário (Completo)</span>
                    </div>
                    <div className="flex justify-between border-b border-[rgba(255,255,255,0.15)] pb-3">
                      <span>Interatividade WebGL e 3D Motion</span>
                    </div>
                    <div className="flex justify-between border-b border-[rgba(255,255,255,0.15)] pb-3">
                      <span>Desenvolvimento Monolítico Customizado</span>
                    </div>
                    <div className="flex justify-between border-b border-[rgba(255,255,255,0.15)] pb-3">
                      <span>Diretor de Arte Exclusivo</span>
                    </div>
                  </div>

                  <MagneticButton
                    href={getWhatsAppLink(
                      "Olá! Exijo a Operação Elite (Black) de R$9.800 para dominar meu mercado."
                    )}
                    className="be-btn-secondary w-full magnetic-trigger text-center justify-center mt-auto"
                  >
                    Ascender ao Elite
            ...
            >
              <h2 className="text-4xl md:text-8xl font-light tracking-tighter mb-20 md:mb-40 mix-blend-difference">
                ...
                <span className="text-gradient-white">
                  acabou de voltar no tempo.
                </span>
              </h2>

              <MagneticButton
                href={getWhatsAppLink(
                  "Estou pronto para o Choque de Autoridade. Requisitar Pulse Black."
                )}
                className="be-btn-primary magnetic-trigger shadow-[0_0_80px_rgba(255,255,255,0.15)]"
              >
              ...
              <img
                src="/pulseblack.png"
                alt="Pulse Black Footer"
                className="mx-auto mt-32 w-24 opacity-20"
              />
            </motion.div>
          </section>
        </>
