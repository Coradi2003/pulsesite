...
export default function SiteParaEmpresaCuritiba() {
  useEffect(() => {
    ...
    metaDesc.setAttribute(
      "content",
      "Criamos sites profissionais para empresas em Curitiba que querem mais credibilidade, presença digital e clientes. Solicite um orçamento."
    );
    ...
    canonical.setAttribute(
      "href",
      "https://pulsefuturo.com.br/site-para-empresa-curitiba"
    );
    ...
    <div className="landing-page">
          ...
          <div className="hero-inner">
            <div className="hero-content">
              ...
              <p className="hero-subtitle">
                Criamos sites corporativos para empresas de Curitiba que
                precisam transmitir credibilidade, conquistar a confiança dos
                clientes e fortalecer sua presença digital com uma identidade
      ...
      <section className="section" id="intro">
        <div className="container">
          <div className="text-center reveal">
            ...
            >
              Em Curitiba, o mercado corporativo é competitivo e exigente. Antes
              de fechar qualquer negócio, seus potenciais clientes pesquisam sua
              empresa online. Um site corporativo profissional é o cartão de
              visitas digital da sua empresa — ele transmite seriedade, organiza
              suas informações e facilita o contato com quem já está pronto para
              contratar.
            </p>
          </div>
        </div>
          ...
          <div className="solucao-cards">
            <div className="solucao-card reveal delay-1">
              ...
              <p className="card-text">
                Empresas com site profissional transmitem confiança antes mesmo
                do primeiro contato. Seus clientes chegam mais seguros e prontos
                para fechar negócio.
              </p>
            </div>
            <div className="solucao-card reveal delay-2">
              ...
              <p className="card-text">
                Apareça no Google quando seus clientes pesquisarem pelos
                serviços que você oferece. Um site bem estruturado é a base de
                qualquer estratégia digital.
              </p>
            </div>
            <div className="solucao-card reveal delay-3">
              <h3 className="card-title">Contato e Orçamentos Facilitados</h3>
              <p className="card-text">
                Formulários, botões de WhatsApp e informações organizadas tornam
                mais fácil para o cliente entrar em contato e solicitar uma
                proposta comercial.
              </p>
            </div>
          </div>
          ...
          <div className="steps-container">
            <div className="step-item reveal delay-1">
              ...
              <p className="step-text">
                Analisamos seu segmento, seus diferenciais competitivos e o
                perfil dos seus clientes para criar uma estrutura que comunique
                o valor real da sua empresa.
              </p>
            </div>
            <div className="step-item reveal delay-2">
              ...
              <p className="step-text">
                Desenvolvemos um layout moderno e alinhado à identidade visual
                da sua marca, com hierarquia clara de informações e foco na
            ...
            <div className="step-item reveal delay-3">
              ...
              <p className="step-text">
                Publicamos seu site com domínio, hospedagem e configurações
                técnicas incluídas, com suporte disponível para atualizações e
                melhorias futuras.
              </p>
            </div>
          </div>
          ...
          <div className="autoridade-inner">
            <div className="reveal-left">
              ...
              <p className="section-subtitle">
                Não entregamos apenas um site bonito. Entregamos uma presença
                digital estratégica, pensada para representar sua empresa com
                profissionalismo e gerar resultados reais no mercado de
                Curitiba.
              </p>
            </div>
              ...
              <div className="autoridade-metrics">
                <div className="metric-card">
                  ...
                  <div className="metric-label">
                    Dias para seu site corporativo entrar no ar
                  </div>
                </div>
                <div className="metric-card">
                ...
                <div className="metric-card">
                  ...
                  <div className="metric-label">
                    Domínio e hospedagem inclusos no plano
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="container">
          <div className="text-center reveal">
            ...
            <h2 className="section-title">
              ...
              <span>Site para Empresa em Curitiba</span>
            </h2>
          </div>
        ...
        <div className="container">
          <div className="cta-box reveal">
            ...
            <p className="cta-subtitle">
              Não deixe seus clientes encontrarem a concorrência antes de você.
              Fale com a Pulse Futuro e tenha um site corporativo profissional
      ...
      <script type="application/ld+json">
        {JSON.stringify({
          ...
          description:
            "Criamos sites profissionais para empresas em Curitiba que querem mais credibilidade, presença digital e clientes.",
      ...
      <script type="application/ld+json">
        {JSON.stringify({
          ...
          mainEntity: [
            {
              "@type": "Question",
              name: "Quanto custa um site para empresa em Curitiba?",
              acceptedAnswer: {
                "@type": "Answer",
                text: "O investimento varia conforme o porte do projeto. Na Pulse Futuro, temos planos a partir de R$ 350 para sites de uma página e opções mais completas para empresas que precisam de múltiplas seções, formulários e integração com redes sociais.",
              },
            },
            {
              "@type": "Question",
              name: "Qual é o prazo de entrega de um site corporativo?",
              acceptedAnswer: {
                "@type": "Answer",
                text: "O prazo médio é de 3 a 7 dias úteis após o envio das informações e aprovação do briefing. Projetos mais completos podem levar até 15 dias, sempre com acompanhamento próximo em cada etapa.",
              },
            },
            {
              "@type": "Question",
              name: "Um site profissional realmente ajuda a passar mais confiança?",
              acceptedAnswer: {
                "@type": "Answer",
                text: "Sim. Mais de 75% dos consumidores julgam a credibilidade de uma empresa pela qualidade do seu site. Uma presença digital bem estruturada transmite seriedade antes mesmo do primeiro contato comercial.",
              },
            },
            {
              "@type": "Question",
              ...
              acceptedAnswer: {
                "@type": "Answer",
                text: "Sim. Todos os sites que desenvolvemos são 100% responsivos, adaptando-se perfeitamente a smartphones, tablets e computadores.",
              },
            },
            {
              "@type": "Question",
              name: "O site ajuda minha empresa a aparecer no Google?",
              acceptedAnswer: {
                "@type": "Answer",
                text: "Sim. Desenvolvemos todos os sites com boas práticas de SEO: headings corretos, URLs amigáveis, meta tags, velocidade de carregamento e código limpo para as melhores condições de aparecer nas buscas locais.",
              },
            },
            {
              "@type": "Question",
              name: "Domínio e hospedagem estão inclusos no plano?",
              acceptedAnswer: {
                "@type": "Answer",
                text: "Sim. Nossos planos incluem domínio .com.br por 1 ano e hospedagem de alta performance. Cuidamos de toda a parte técnica para que você foque no seu negócio.",
              },
            },
          ],
        })}
