...
export default function FinancePage() {
  ...
  const [expenseForm, setExpenseForm] =
    useState<Omit<Finance, "id">>(EMPTY_EXPENSE);
  ...
  const totalPaid = finance
    .filter(f => f.status === "paid" && f.amount > 0)
  ...
  const handleSaveExpense = async () => {
    ...
    await create({
      ...
      client_id: expenseForm.client_id || (clients[0]?.id ?? ""),
    });
    setSaving(false);
  ...
  return (
    <AdminLayout>
      <div id="admin-finance">
        <PageHeader
          title="Finanças"
          description="Controle de pagamentos e receitas"
        />
          ...
          {[
            ...
            <div
              ...
              className={cn(
                ...
                bg,
                "bg-[#0d0a1a]/80 flex flex-col justify-between min-h-[90px]"
              )}
            >
                  ...
                  : finance.map(f => (
                      <motion.tr
                        ...
                        className={cn(
                          ...
                          f.status === "overdue" && "bg-red-500/[0.03]"
                        )}
                      >
                        ...
                        <td className="px-5 py-3.5 text-white font-semibold">
                          <span
                            className={
                              f.amount < 0 ? "text-red-400" : "text-white"
                            }
                          >
                            {f.amount < 0
                              ? `- ${formatBRL(Math.abs(f.amount))}`
                              : formatBRL(f.amount)}
                          </span>
                        </td>
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    ...
                    <select
                      ...
                      className="w-full h-9 px-3 rounded-lg bg-white/5 border border-purple-900/40 text-white text-sm focus:outline-none"
                    >
                      <option value="monthly" className="bg-[#0d0a1a]">
                        Mensal
                      </option>
                      <option value="one-time" className="bg-[#0d0a1a]">
                        Único
                      </option>
                    </select>
                  </div>
                  <div>
                    ...
                    <select
                      ...
                      className="w-full h-9 px-3 rounded-lg bg-white/5 border border-purple-900/40 text-white text-sm focus:outline-none"
                    >
                      <option value="pending" className="bg-[#0d0a1a]">
                        Pendente
                      </option>
                      <option value="paid" className="bg-[#0d0a1a]">
                        Pago
                      </option>
                      <option value="overdue" className="bg-[#0d0a1a]">
                        Em atraso
                      </option>
                    </select>
                  </div>
            ...
            >
                ...
                {clients.length > 0 && (
                  <div>
                    ...
                    <select
                      ...
                      className="w-full h-9 px-3 rounded-lg bg-white/5 border border-red-500/20 text-white text-sm focus:outline-none"
                    >
                      <option value="" className="bg-[#0d0a1a]">
                        — Nenhum —
                      </option>
                      {clients.map(c => (
                        <option
              ...
              <div className="flex gap-3 mt-6">
                ...
                <Button
                  ...
                  disabled={
                    saving || !expenseForm.description || !expenseForm.amount
                  }
