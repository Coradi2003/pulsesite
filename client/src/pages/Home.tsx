        ...
        <div className="container">
          <div className="navbar-inner">
            <a href="#" className="navbar-logo">
              ...
              <span className="navbar-logo-text">Pulse <span>Futuro</span></span>
            </a>
          ...
          <div className="hero-inner">
            <div className="hero-content">
              ...
              <h1 className="hero-title">
                Seu negócio ainda<br />
                <span className="highlight">não tem site?</span>
              </h1>
              <p className="hero-subtitle">
                Colocamos sua empresa no digital e ajudamos você a atrair mais clientes todos os dias — com um site profissional, moderno e feito para converter.
              </p>
              <div className="hero-buttons">
                ...
                <a href="https://wa.me/5541984606633?text=Quero%20meu%20site%20profissional!" className="btn btn-whatsapp btn-lg" target="_blank" rel="noopener noreferrer">
              ...
              <div className="hero-stats">
                <div className="hero-stat-item">
                  ...
                  <span className="hero-stat-label">dos consumidores<br />pesquisam online</span>
                </div>
                <div className="hero-stat-item">
                  <span className="hero-stat-number">3x</span>
                  <span className="hero-stat-label">mais contatos<br />com site otimizado</span>
                </div>
                <div className="hero-stat-item">
                  <span className="hero-stat-number">3h</span>
                  <span className="hero-stat-label">para seu site<br />entrar no ar</span>
                </div>
              </div>
            </div>
          ...
          <div className="problema-grid">
            <div className="reveal-left">
              ...
              <h2 className="section-title">
                Você pode estar perdendo<br />
                <span>clientes todos os dias</span>
              </h2>
              <p className="section-subtitle">
                Hoje, antes de qualquer compra ou contratação, as pessoas abrem o Google. Se sua empresa não aparece, ela simplesmente não existe para esses clientes.
              </p>
              ...
              <div className="problema-list">
                <div className="problema-item">
                  ...
                  <div className="problema-item-text">
                    ...
                    <p>Sem site, seu negócio não aparece nas buscas e perde espaço para a concorrência que já está online.</p>
                  </div>
                </div>
                <div className="problema-item">
                  <div className="problema-icon">
                  ...
                  <div className="problema-item-text">
                    ...
                    <p>Clientes desconfiam de empresas sem presença digital. Um site profissional transmite confiança imediata.</p>
                  </div>
                </div>
                <div className="problema-item">
                  <div className="problema-icon">
                  ...
                  <div className="problema-item-text">
                    ...
                    <p>Depender apenas de indicações limita seu alcance. O digital abre sua empresa para novos mercados 24h por dia.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="reveal-right">
              <div className="alert-box">
                ...
                <p className="alert-text">
                  dos consumidores brasileiros pesquisam na internet antes de comprar ou contratar um serviço local. Empresas sem site ficam <strong style={{ color: 'var(--purple-light)' }}>completamente invisíveis</strong> para essa maioria.
                </p>
                ...
                <div style={{ marginTop: '32px', paddingTop: '28px', borderTop: '1px solid var(--border)' }}>
                  <div className="alert-number" style={{ fontSize: '3rem' }}>+60%</div>
                  <p className="alert-text">
                    das buscas locais no Google resultam em uma visita à loja ou contato com a empresa nas próximas 24 horas.
                  </p>
                </div>
              </div>
            </div>
      ...
      <section className="section" id="solucao">
        <div className="container">
          <div className="text-center reveal">
            ...
            <h2 className="section-title">Como a Pulse Futuro <span>resolve isso</span></h2>
            <p className="section-subtitle">
              Desenvolvemos sites profissionais e estratégicos para comércios locais que querem crescer no digital com resultados reais.
            </p>
          </div>
          ...
          <div className="solucao-cards">
            <div className="solucao-card reveal delay-1">
              ...
              <p className="card-text">Design exclusivo, alinhado à identidade da sua marca, com visual premium que impressiona e gera confiança imediata.</p>
            ...
            <div className="solucao-card reveal delay-2">
              ...
              <p className="card-text">Mais de 80% dos acessos são pelo smartphone. Seu site será perfeito em qualquer tela, garantindo a melhor experiência.</p>
              <ul className="card-feature-list">
            ...
            <div className="solucao-card reveal delay-3">
              ...
              <p className="card-text">Estrutura estratégica com calls-to-action inteligentes, formulários e integração com WhatsApp para converter visitantes em clientes.</p>
              <ul className="card-feature-list">
      ...
      <section className="section como-funciona" id="como-funciona">
        <div className="container">
          <div className="text-center reveal">
            ...
            <p className="section-subtitle">
              Processo simples, rápido e sem complicação. Do primeiro contato ao site no ar em poucos dias.
            </p>
          </div>
          ...
          <div className="steps-container">
            <div className="step-item reveal delay-1">
              ...
              <p className="step-text">Conversamos para entender seu segmento, seus diferenciais, seu público-alvo e o que você precisa comunicar. Nenhum detalhe é ignorado.</p>
            </div>

            <div className="step-item reveal delay-2">
              <div className="step-number">02</div>
              <h3 className="step-title">Criamos o layout personalizado</h3>
              <p className="step-text">Nossa equipe desenvolve um design exclusivo para sua marca, com textos persuasivos e estrutura pensada para converter visitantes em clientes.</p>
            </div>

            <div className="step-item reveal delay-3">
              <div className="step-number">03</div>
              <h3 className="step-title">Colocamos seu site no ar</h3>
              <p className="step-text">Após sua aprovação, publicamos o site com domínio e hospedagem configurados. Seu negócio estará online e pronto para atrair clientes.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          <div className="autoridade-inner">
            <div className="reveal-left">
              ...
              <h2 className="section-title">
                Presença digital é o novo<br />
                <span>cartão de visitas</span>
              </h2>
              <p className="section-subtitle">
                No mundo conectado de hoje, seu site é a primeira impressão que os clientes têm da sua empresa. Uma presença digital profissional não é mais um diferencial — é uma necessidade para qualquer negócio que queira crescer.
              </p>
              <blockquote className="autoridade-quote">
                "Empresas com site profissional geram até 3 vezes mais contatos e têm percepção de valor significativamente maior pelos consumidores digitais."
              </blockquote>
            </div>
            ...
            <div className="reveal-right">
              <div className="autoridade-metrics">
                <div className="metric-card">
                  ...
                  <div className="metric-label">Aumento médio de visibilidade online com site otimizado</div>
                </div>
                <div className="metric-card">
                  <div className="metric-number">24/7</div>
                  <div className="metric-label">Seu negócio trabalhando para você enquanto você descansa</div>
                </div>
                <div className="metric-card">
                  <div className="metric-number">3x</div>
                  <div className="metric-label">Mais credibilidade percebida pelos clientes</div>
                </div>
                <div className="metric-card">
        ...
        <div className="container">
          <div className="cta-box reveal">
            ...
            <h2 className="cta-title">
              Está pronto para colocar<br />
              <span style={{ color: 'var(--purple-bright)', textShadow: '0 0 30px rgba(138,43,226,0.6)' }}>sua empresa no digital?</span>
            </h2>
            <p className="cta-subtitle">
              Quanto você está deixando de faturar por não ter um site?
            </p>
            <div className="cta-buttons">
              <a href="https://wa.me/5541984606633?text=Quero%20meu%20site%20profissional!" className="btn btn-primary btn-lg" target="_blank" rel="noopener noreferrer">
                <i className="fas fa-rocket"></i>
          ...
          <div className="footer-inner">
            <div>
              ...
              <p className="footer-tagline">
                Serviços de marketing na internet.<br />
                Transformamos negócios locais em referências digitais.
              </p>
              <a href="https://wa.me/5541984606633?text=Quero%20meu%20site%20profissional!" className="btn btn-whatsapp" target="_blank" rel="noopener noreferrer" style={{ fontSize: '0.9rem', padding: '11px 22px' }}>
                <i className="fab fa-whatsapp"></i>
                Falar no WhatsApp
              </a>
            </div>
            ...
            <div>
              ...
              <ul className="footer-list">
                ...
                <li>
                  <i className="fab fa-whatsapp"></i>
                  <a href="https://wa.me/5541984606633?text=Quero%20meu%20site%20profissional!" target="_blank" rel="noopener noreferrer">(41) 98460-6633</a>
                </li>
                <li>
