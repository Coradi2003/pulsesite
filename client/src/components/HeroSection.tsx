    ...
    <>
      ...
      <section className="hero" id="hero">
        ...
        <h1 className="sr-only">
          Criação de Sites e Landing Pages em Curitiba | Pulse Futuro
        </h1>
        ...
        <div className="hero-fireworks">
          ...
          ></span>
          <span
            className="fw-particle fw-violet"
            style={
              {
                "--x": "12%",
                "--delay": "0.5s",
          ...
          <div className="hero-inner">
            <div className="hero-content">
              ...
              <p className="hero-subtitle">
                Colocamos sua empresa no digital e ajudamos você a atrair mais
                clientes todos os dias — com um site profissional, moderno e
